...
import masterrtl.pyverilog.controlflow.splitter as splitter
import masterrtl.pyverilog.controlflow.transition as transition
...
import masterrtl.pyverilog.utils.util as util
from masterrtl.pyverilog.dataflow.dataflow import *
from masterrtl.pyverilog.dataflow.subset import VerilogSubset
from masterrtl.pyverilog.dataflow.walker import VerilogDataflowWalker
...
class FiniteStateMachine:
    ...
    def get_loop(self):
        ...
        for k in sorted(self.fsm.keys()):
            if k not in self.fsm:
                continue
            if k not in loop_node_cnt:
                loop_node_cnt[k] = 0
